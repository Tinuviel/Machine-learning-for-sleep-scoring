...
matData = scipy.io.loadmat('rat5_all.mat')
...
model.fit(x_train, y_train, epochs=30, batch_size=512, shuffle = True, validation_data = (x_val, y_val), class_weight = class_weight, verbose=2)
